...
public class CzekoladowyKociolKlasyczny {
	private static CzekoladowyKociolKlasyczny czekoladowyKociol;

	private CzekoladowyKociolKlasyczny(){
		pusty = true;
		ugotowany = false;
	...
	public static CzekoladowyKociolKlasyczny getInstance() {
		if (czekoladowyKociol == null) {
			czekoladowyKociol = new CzekoladowyKociolKlasyczny();
		}
		return czekoladowyKociol;
	}
