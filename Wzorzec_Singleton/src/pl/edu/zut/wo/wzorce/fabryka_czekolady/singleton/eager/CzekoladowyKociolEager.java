...
public class CzekoladowyKociolEager {

	private static CzekoladowyKociolEager czekoladowyKociolEager = new CzekoladowyKociolEager();
	private boolean pusty;
	private boolean ugotowany;

	private CzekoladowyKociolEager() {
		pusty = true;
		ugotowany = false;
		System.out.println("Utworzenie instancji Czekoladowego Kotła: " + this);
	}
	public static synchronized CzekoladowyKociolEager getInstance(){
		return czekoladowyKociolEager;
	}
